package com.aihuishou.zbarlib.view;
...
import com.aihuishou.zbarlib.R;
...
public class ScanView extends FrameLayout {
    ...
    private AppCompatImageView iv_scan_line;
    ...
    private void initView(Context mContext){
        ...
        iv_scan_line = (AppCompatImageView) scan_view.findViewById(R.id.iv_scan_line);
    ...
    public void setType(int type){
        ...
        if(CURRENT_TYEP == QrConfig.SCANVIEW_TYPE_QRCODE){
            fl_params.width = dip2px(240);
            fl_params.height = dip2px(240);
